...
class ValidateAsshWeights(Action):
    def name(self) -> Text:
        return "actions_assg_weight"
...
#        slot_value: Any,
        ...
        slot_value = tracker.get_slot('assg_weight')
        ...
        if slot_value:
            ...
            msg = "The weightage of assignments of " + str(module_name) + " are:" + "\n" + str(slot_value) + "."
            
            dispatcher.utter_message(text=msg)
        elif slot_value is None or math.isnan(slot_value):
            dispatcher.utter_message(text = "Can't find the percentage of assignment weight in the database please contact support.")
        else:
            dispatcher.utter_message(text = "Can't find the percentage of assignment weight in the database please contact support.")
